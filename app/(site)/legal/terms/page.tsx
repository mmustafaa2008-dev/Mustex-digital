  ...
  return (
    <>
      ...
      <MarketingPage
        ...
        description="The terms that govern use of the Mustex Digitals website and engagement for professional services."
      ...
      >
        <div className="mx-auto max-w-3xl space-y-4 text-sm leading-[var(--leading-body)] text-[var(--ds-foreground-muted)]">
          <p>
            ...
            purposes and to engage Mustex Digitals under a separate statement of
            work for delivery engagements.
          </p>
          <p>
            Project scope, timelines, and commercial terms are defined in written
            agreements between Mustex Digitals and the client.
          </p>
        </div>
      </MarketingPage>
    </>
